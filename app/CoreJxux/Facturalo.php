...
use App\Models\System\Voided;
use App\Models\System\Company;
use App\Models\System\Invoice;
use App\Models\System\Summary;
use Mpdf\Config\FontVariables;
use App\Models\System\Dispatch;
use App\Models\System\Document;
use App\Models\System\Retention;
use Mpdf\Config\ConfigVariables;
use App\Models\System\Perception;
use App\Mail\System\DocumentEmail;
use App\Models\System\Configuration;
use Illuminate\Support\Facades\Mail;
use Modules\Finance\Traits\FinanceTrait;
use App\CoreJxux\WS\Client\WsClient;
use App\CoreJxux\Helpers\Xml\XmlHash;
use App\CoreJxux\WS\Signed\XmlSigned;
use App\CoreJxux\Helpers\Xml\XmlFormat;
use App\CoreJxux\WS\Services\BillSender;
use App\CoreJxux\WS\Services\ExtService;
use App\CoreJxux\WS\Services\SummarySender;
use App\CoreJxux\WS\Services\SunatEndpoints;
use App\CoreJxux\Helpers\QrCode\QrCodeGenerate;
use App\CoreJxux\WS\Services\ConsultCdrService;
use App\CoreJxux\Helpers\Storage\StorageDocument;
use App\CoreJxux\WS\Validator\XmlErrorCodeProvider;
...
class Facturalo
{
    ...
    public function createPdf($document = null, $type = null, $format = null) {
        ...
        $base_pdf_template = $configuration;//config(['System.pdf_template'=> $configuration]);
            ...
            ($format_pdf === 'ticket_50'))
        {
            ...
            if(config('System.enabled_template_ticket_80')) $width = 76;
            if(config('System.enabled_template_ticket_70')) $width = 70;
            ...
            $pdf_font_regular = config('System.pdf_name_regular');
            $pdf_font_bold = config('System.pdf_name_bold');
            ...
            if ($pdf_font_regular != false) {
                ...
                $pdf = new Mpdf([
                    'fontDir' => array_merge($fontDirs, [
                        app_path('CoreJxux'.DIRECTORY_SEPARATOR.'Templates'.
        ...
        $path_css = app_path('CoreJxux'.DIRECTORY_SEPARATOR.'Templates'.
                                             DIRECTORY_SEPARATOR.'pdf'.
                                             DIRECTORY_SEPARATOR.$base_pdf_template.
        ...
        if (($format_pdf != 'ticket') AND ($format_pdf != 'ticket_58') AND ($format_pdf != 'ticket_50')) {
            // dd($base_pdf_template);// = config(['System.pdf_template'=> $configuration]);
            if(config('System.pdf_template_footer')) {
...
//            $message = 'La SUNAT no responde a su solicitud, vuelva a intentarlo.';
    ...
    private function setPathCertificate()
    {
        if($this->isOse) {
            ...
            if($this->isDemo) {
                $this->pathCertificate = app_path('CoreJxux'.DIRECTORY_SEPARATOR.
