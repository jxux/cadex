...
namespace App\CoreJxux\Helpers\Storage;
...
trait StorageDocument
{
    ...
    public function uploadStorage($filename, $file_content, $file_type, $root = null)
    {
        ...
        Storage::disk('System')->put($this->_folder.DIRECTORY_SEPARATOR.$this->_filename, $file_content);
    }

    public function downloadStorage($filename, $file_type, $root = null)
    {
        $this->setData($filename, $file_type, $root);
        return Storage::disk('System')->download($this->_folder.DIRECTORY_SEPARATOR.$this->_filename);
    }

    public function getStorage($filename, $file_type, $root = null)
    {
        $this->setData($filename, $file_type, $root);
        return Storage::disk('System')->get($this->_folder.DIRECTORY_SEPARATOR.$this->_filename);
    }
