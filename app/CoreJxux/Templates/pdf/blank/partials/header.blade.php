@php
    ...
    $accounts = \App\Models\System\BankAccount::all();
...
<table class="full-width p-0">
    <tr>
        ...
        <td width="40%" class="align-top" style="text-transform: uppercase; line-height: 20px;">
            @php
                $district = \App\Models\System\Catalogs\District::find($document->origin->location_id);
            @endphp
        ...
        <td width="40%" class="align-top" style="text-transform: uppercase; line-height: 20px;">
            @php
                $district = \App\Models\System\Catalogs\District::find($document->delivery->location_id);
            @endphp
