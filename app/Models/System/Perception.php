...
use App\Models\System\Catalogs\PerceptionType;
...
class Perception extends Model
{
    ...
    {
        return route('System.download.external_id', ['model' => 'perception', 'type' => 'xml', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalPdfAttribute()
    {
        return route('System.download.external_id', ['model' => 'perception', 'type' => 'pdf', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalCdrAttribute()
    {
        return route('System.download.external_id', ['model' => 'perception', 'type' => 'cdr', 'external_id' => $this->external_id]);
    }
