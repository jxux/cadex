...
use App\Models\System\Catalogs\RetentionType;
...
class Retention extends Model
{
    ...
    {
        return route('System.download.external_id', ['model' => 'retention', 'type' => 'xml', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalPdfAttribute()
    {
        return route('System.download.external_id', ['model' => 'retention', 'type' => 'pdf', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalCdrAttribute()
    {
        return route('System.download.external_id', ['model' => 'retention', 'type' => 'cdr', 'external_id' => $this->external_id]);
    }
}