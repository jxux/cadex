...
use App\Notifications\System\PasswordResetNotification;
...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'nick_name', 'password', 'establishment_id','type','locked', 'identity_document_type_id', 'number', 'address', 'telephone'
    ];
