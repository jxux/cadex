...
class Voided extends Model
{
    ...
    {
        return route('System.download.external_id', ['model' => 'voided', 'type' => 'xml', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalPdfAttribute()
    {
        return route('System.download.external_id', ['model' => 'voided', 'type' => 'pdf', 'external_id' => $this->external_id]);
    }

    public function getDownloadExternalCdrAttribute()
    {
        return route('System.download.external_id', ['model' => 'voided', 'type' => 'cdr', 'external_id' => $this->external_id]);
    }
